    ...
    <v-app>
        ...
        <v-toolbar app dark color="primary">
            ...
            <v-toolbar-items class="hidden-sm-and-down">
                ...
                <v-btn v-if="!isUserLoggedIn" @click="togleLoginDialog" flat>
                    <v-icon left>lock</v-icon>
                    Войти
                </v-btn>
                <v-btn v-if="!isUserLoggedIn" @click="togleRegisterDialog" flat>
                    <v-icon left>face</v-icon>
                    Регистрация
                </v-btn>
...
<script>
    ...
    export default {
        ...
        computed: {
            loginDialog() {
                console.log(
                    'kogin dialog changed =>',
                    this.$store.getters.loginDialog
                );
